...
export default async function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Tam animasyon_logo.svg - A harfi + çember */}
        <svg
          width="600"
          height="630"
        ...
        >
          <defs>
            <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
              ...
              <stop offset="0.5" style={{ stopColor: '#0099ff', stopOpacity: 1 }} />
              <stop offset="1" style={{ stopColor: '#00ccff', stopOpacity: 1 }} />
            </linearGradient>
          </defs>
          <g>
            {/* A harfi */}
