        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="relative">
              ...
              <div className="relative bg-gradient-to-r from-primary-500 to-secondary-500 text-white font-bold text-xl md:text-2xl px-3 py-1.5 rounded-lg">
                A
              </div>
            </div>
            <span className="font-bold text-xl md:text-2xl bg-gradient-to-r from-primary-500 to-secondary-500 bg-clip-text text-transparent">
              Automexus
            </span>
          </Link>
